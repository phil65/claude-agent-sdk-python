...
#   timestamp: 2026-04-23T20:01:58+00:00
...
class AdditionalDirectory(ClaudeMdExclude):
    pass


class EnabledMcpjsonServer(ClaudeMdExclude):
    pass


class DisabledMcpjsonServer(ClaudeMdExclude):
    pass
...
class HttpHookAllowedEnvVar(ClaudeMdExclude):
    pass


class AllowedHttpHookUrl(ClaudeMdExclude):
    pass
...
class SkippedMarketplace(ClaudeMdExclude):
    pass


class SkippedPlugin(ClaudeMdExclude):
    pass


class AllowedDomain(ClaudeMdExclude):
    pass
...
class AllowWriteItem(ClaudeMdExclude):
    pass


class DenyWriteItem(ClaudeMdExclude):
    pass


class DenyReadItem(ClaudeMdExclude):
    pass


class AllowReadItem(ClaudeMdExclude):
    pass


class Filesystem(ClaudeCodeBaseModel):
    """Filesystem access control for sandboxed commands. See https://code.claude.com/docs/en/sandboxing#filesystem-isolation."""

    model_config = ConfigDict(
        extra="forbid",
    )
    allow_write: list[AllowWriteItem] | None = Field(None, alias="allowWrite")
    """
    ...
    """
    deny_write: list[DenyWriteItem] | None = Field(None, alias="denyWrite")
    """
    Paths where subprocesses are explicitly denied write access. Takes precedence over allowWrite
    """
    deny_read: list[DenyReadItem] | None = Field(None, alias="denyRead")
    """
    Paths where subprocesses are explicitly denied read access
    """
    allow_read: list[AllowReadItem] | None = Field(None, alias="allowRead")
    """
    Paths to re-allow reading within denyRead regions. Takes precedence over denyRead for matching paths
    """
    allow_managed_read_paths_only: bool | None = Field(None, alias="allowManagedReadPathsOnly")
    """
...
class CompanyAnnouncement(ClaudeMdExclude):
    pass


class SparsePath(ClaudeMdExclude):
    pass


class Worktree(ClaudeCodeBaseModel):
    ...
    sparse_paths: list[SparsePath] | None = Field(
        None, alias="sparsePaths", examples=[["packages/my-app", "shared/utils"]]
    )
    """
...
class AllowedEnvVar(ClaudeMdExclude):
    pass


class HookConfigHttp(ClaudeCodeBaseModel):
    """HTTP webhook hook. POST JSON to a URL and receive JSON response. See https://code.claude.com/docs/en/hooks#http-hooks."""
    ...
    """
    allowed_env_vars: list[AllowedEnvVar] | None = Field(None, alias="allowedEnvVars")
    """
...
class HookMatcher(ClaudeCodeBaseModel):
    ...
    """
    hooks: list[HookConfigCommand | HookConfigPrompt | HookConfigAgent | HookConfigHttp]
    """
...
class Permissions(ClaudeCodeBaseModel):
    ...
    default_mode: (
        Literal[
            "acceptEdits", "bypassPermissions", "default", "delegate", "dontAsk", "plan", "auto"
        ]
        | None
...
class Hooks(ClaudeCodeBaseModel):
    ...
    """
    post_compact: list[HookMatcher] | None = Field(None, alias="PostCompact")
    """
    Hooks that run after the context is compacted. See https://code.claude.com/docs/en/hooks
    """
    elicitation: list[HookMatcher] | None = Field(None, alias="Elicitation")
    """
    Hooks that run when an MCP server requests user input during a tool call. See https://code.claude.com/docs/en/hooks
    """
    elicitation_result: list[HookMatcher] | None = Field(None, alias="ElicitationResult")
    """
    ...
    """
    cwd_changed: list[HookMatcher] | None = Field(None, alias="CwdChanged")
    """
    ...
    """
    file_changed: list[HookMatcher] | None = Field(None, alias="FileChanged")
    """
...
class ClaudeCodeSettings(ClaudeCodeBaseModel):
    ...
    """
    auto_memory_enabled: bool | None = Field(True, alias="autoMemoryEnabled")
    """
    ...
    """
    effort_level: Literal["low", "medium", "high", "xhigh"] | None = Field(
        None, alias="effortLevel"
    )
    """
    ...
    feedback_survey_rate: float | None = Field(
        None, alias="feedbackSurveyRate", examples=[0.05], ge=0.0, le=1.0
    )
    """
    ...
    http_hook_allowed_env_vars: list[HttpHookAllowedEnvVar] | None = Field(
        None, alias="httpHookAllowedEnvVars", examples=[["MY_TOKEN", "HOOK_SECRET"]]
    )
    """
